...
app.get('/rooms', (request, response) => {
    var rects = [
            ...
            {x:238, y:336, w:23, h:36, roomname:'e33', status: 'free', interactable: false, user: ""},
            {x:256, y:393, w:23, h:41, roomname:'e35', status: 'free', interactable: false, user: ""},
            {x:281, y:393, w:12, h:41, roomname:'e36', status: 'free', interactable: false, user: ""},
            {x:295, y:393, w:11, h:31, roomname:'e38', status: 'free', interactable: false, user: ""},
            {x:307, y:385, w:57, h:38, roomname:'e39', status: 'free', interactable: false, user: ""},
            {x:397, y:291, w:29, h:75, roomname:'e42', status: 'free', interactable: false, user: ""},
            {x:331, y:291, w:29, h:75, roomname:'e46', status: 'free', interactable: false, user: ""},
            {x:361, y:309, w:11, h:54, roomname:'e47', status: 'free', interactable: false, user: ""}, 
            {x:393, y:385, w:56, h:38, roomname:'e48', status: 'free', interactable: false, user: ""},
            {x:450, y:393, w:12, h:30, roomname:'e49', status: 'free', interactable: false, user: ""},
            {x:464, y:336, w:13, h:28, roomname:'e50', status: 'free', interactable: false, user: ""},
            {x:464, y:393, w:44, h:40, roomname:'e51', status: 'free', interactable: false, user: ""},
            {x:478, y:336, w:12, h:36, roomname:'e52', status: 'free', interactable: false, user: ""},
            {x:491, y:336, w:12, h:36, roomname:'e53', status: 'free', interactable: false, user: ""},
            {x:503, y:336, w:16, h:36, roomname:'e54', status: 'free', interactable: false, user: ""},
            {x:555, y:393, w:14, h:39, roomname:'e56', status: 'free', interactable: false, user: ""},
            {x:568, y:393, w:14, h:39, roomname:'e57', status: 'free', interactable: false, user: ""},
            {x:556, y:336, w:32, h:36, roomname:'e58', status: 'free', interactable: false, user: ""},
            {x:556, y:268, w:32, h:65, roomname:'e59', status: 'free', interactable: false, user: ""},
            {x:515, y:261, w:25, h:16, roomname:'e60', status: 'free', interactable: false, user: ""},
            {x:556, y:253, w:32, h:15, roomname:'e61', status: 'free', interactable: false, user: ""},
            {x:556, y:174, w:32, h:75, roomname:'e62', status: 'free', interactable: false, user: ""},
            {x:514, y:161, w:25, h:98, roomname:'e63', status: 'free', interactable: false, user: ""},
            {x:556, y:106, w:32, h:66, roomname:'e64', status: 'free', interactable: false, user: ""},
            {x:556, y:90, w:32, h:14, roomname:'e65', status: 'free', interactable: false, user: ""},
            {x:556, y:70, w:32, h:18, roomname:'e66', status: 'free', interactable: false, user: ""},
            {x:505, y:71, w:35, h:33, roomname:'e67', status: 'free', interactable: false, user: ""},
            {x:525, y:28, w:44, h:41, roomname:'e68', status: 'free', interactable: false, user: ""},
